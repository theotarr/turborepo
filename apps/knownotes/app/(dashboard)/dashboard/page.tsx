...
export default async function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl flex-col space-y-12 pt-24 lg:pt-32">
      <div className="flex flex-col gap-4">
        <h1 className="font-heading text-pretty text-center text-[29px] font-semibold tracking-tighter sm:text-[32px] md:text-[46px]">
          ...
          {user?.courses.length! > 0 ? (
            ...
            <EmptyPlaceholder>
              ...
              <EmptyPlaceholder.Description>
                You can group your lectures and notes by course, click here to
                add one.
              </EmptyPlaceholder.Description>
              <CourseCreateDialog
                className={buttonVariants({
